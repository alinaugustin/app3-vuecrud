...
export default {
  ...
  methods: {
    updateOpt: function () {
      ...
      this.updatedata.args = this.args[0],
      axios.post('http://localhost:4000/apiargs/updateargsopts/', this.updatedata).then((response) => {
    ...
    allRecords: function () {
        ...
        .then(response => {
         ...
         .catch(error => alert('Eroare: Nu este nimic in baza!'))
        // return this.items,
